...
So your edited pack can often be much larger than it needs to be because it has a bunch of copies of textures from your base pack (which is used as a fallback anyway.) This script automatically removes the copy textures/files and only keeps the ones you edited.
